  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="p-8 bg-white-50">
        <h1 className="text-2xl font-bold text-blue-800">ABOUT US</h1>
        <div className="flex flex-col md:flex-row mt-4 items-center">
        <img src="./images/aboutus.jpg" alt="About Us" className="w-full md:w-1/3 rounded-lg shadow-md transition-transform duration-500 ease-in-out hover:scale-105"/>
