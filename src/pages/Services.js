  ...
  <div className="min-h-screen bg-white">
      ...
      <footer className="bg-blue-500 text-white p-6 text-center">
        ...
        <div className="flex justify-center gap-4 mt-2">
          <span className="bg-white text-blue-500 p-2 rounded-full hover:bg-blue-100 cursor-pointer transition">LinkedIn</span>
          <span className="bg-white text-blue-500 p-2 rounded-full hover:bg-blue-100 cursor-pointer transition">Facebook</span>
          <span className="bg-white text-blue-500 p-2 rounded-full hover:bg-blue-100 cursor-pointer transition">Instagram</span>
        </div>
      </footer>
    </div>
  );
