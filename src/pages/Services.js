      ...
      <section className="container mx-auto py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={index}
              className="bg-white p-6 shadow-md rounded-2xl border-t-4 border-yellow-400 transition-transform duration-500 ease-[cubic-bezier(0.175,_0.885,_0.32,_1.275)] hover:scale-105 hover:shadow-xl"
            >
      ...
      <section className="p-8 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
          {[
            ...
            <div key={index} className="bg-blue-400 text-white p-4 rounded-md text-center">
