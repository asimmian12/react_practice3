  ...
  <div class="font-[sans-serif] my-4">
            <div class="max-w-5xl max-lg:max-w-2xl mx-auto">
                <div class="max-w-2xl mx-auto text-center">
                    <h2 class="text-6xl font-semibold text-center text-blue-600 mb-4">Welcome, {userData.firstName} {userData.surname}!</h2>
                    ...
                    <div class="border rounded-md overflow-hidden max-md:max-w-[300px] hover:bg-blue-600 transition duration-300">
                        ...
                        <div class="p-4">
                            ...
                            <div class="space-x-4 mt-4">
                                ...
                                <button type="button"
                                    class="w-7 h-7 inline-flex items-center justify-center rounded-full border-none outline-none bg-[#03a9f4] hover:bg-[#03a1f4] active:bg-[#03a9f4] hover:bg-blue-600 transition duration-300">
